...
3. Al verificar el deposito, se habilita el formulario de activo, precio y contacto privado.
4. Publica una oferta con la cantidad detectada, activo, precio y contacto privado.
